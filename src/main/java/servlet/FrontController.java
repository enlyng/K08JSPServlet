...
/*
어노테이션을 통한 요청명 매핑으로 *를 통해 여러 요청명을 한꺼번에 매핑한다.
...
public class FrontController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		//request내장객체를 통해 현재 요청된 URI을 얻어온다. 즉 웹브라우저의 주소표시줄에 있는 전체경로명을 얻어올 수 있다.
		//전체경로명에서 host명(localhost)를 제외한 나머지 경로를 얻어올 수 있다.
	...
	405에러가 뜨게 된다. 즉 해당 방식의 요청을 처리할 수 없다는 의미이다.
	 */
//	@Override
