...
/* 
	...
	Object를 기반으로 저장되므로 차후 값을 읽을때에는 해당 타입으로 형변환해야한다.
*/
%>
...
<body>
	...
	//Person과 같이 개발자가 정의한 클래스는 원래타입으로 형변환한다.
	Person pPerson = (Person)(pageContext.getAttribute("pagePerson"));
	%>
	<ul>
		<!-- 자바의 기본클래스인 경우 별도처리없이 즉시 내용을 출력할 수 있다. -->
	...
	<!-- 
		지시어를 통한 include는 포함할 페이지의 원본 소스를 그대로 현재 문서에 포함시킨후
