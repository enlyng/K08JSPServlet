...
/* 
	...
	대한민국은 표준시 +09, 즉 9시간이 느리므로 9시간을 더해줘야 정상적인 날짜가
	출력된다. 만약 9시 이전의 시간이 설정되면 어제날짜가 나오게 된다.
*/
...
<h2>응답 헤더 정보 출력하기</h2>
<%
//getHeaderNames() 메서드를 통해 응답헤더명을 얻어온 후...
...
/* 
첫번째 출력결과에서는 myNumber라는 헤더명이 2번출력되는데 동일한 값이 출력된다.
