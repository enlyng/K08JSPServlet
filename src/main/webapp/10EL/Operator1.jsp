...
<body>
	...
	따라서 스크립트릿에서 선언한 변수는 EL에서 사용할 수 없다.
	 -->
	 <!-- num1은 아무런 값도 출력되지 않는다. -->
	스크립틀릿에서 선언한 변수 : ${num1 }<br>
	page 영역에 저장된 변수 : ${num2 }<br>
	<!-- 
	Tomcat8.0부터 EL에서 변수할당을 할 수 있다. 하지만 변수할당과 동시에
	...
	num1 + "34" : ${num1+"34" }<br>
	<!-- 하지만 숫자와 문자열 혹은 문자열과 문자열의 경우에는 연산불능이므로 예외가 발생한다.
	...
	num3 >= num4 || num3 != num4 : ${num3 ge num4 or num4 ne num4 }
</body>
</html>