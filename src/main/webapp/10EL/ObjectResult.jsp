...
<body>
	...
	<%
	//영역은 모든객체를 저장할 수 있는 공간이므로 Object형으로 저장된다.
	Object object = request.getAttribute("personObj"); //오브젝트 타입임
	//따라서 영역에서 객체를 꺼낸 후 사용할때는 원래이 타입으로 형변환해야한다.
