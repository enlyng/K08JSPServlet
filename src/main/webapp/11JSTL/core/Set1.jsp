...
<title>JSTL - set 1</title>
	...
	속성 정리]
		...
		value : 속성값
		scope : 4가지 영역명을 지정. 미 지정시 가장 좁은 page영역에 지정됨.
		target : set채그를 통해 생성된 자바빈즈의 이름을 지정함.
...
<body>
	...
	<!-- 위 4개의 변수는 scope지정이 없으므로 가장 좁은 page영역에 저장 -->
	...
	<!-- 빈 객체를 생성 후 target, property를 통해 멤버변수의 값을 지정한다. -->
